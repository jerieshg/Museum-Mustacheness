...
//		alarm = GameObject.FindGameObjectWithTag(Tag.Alarm.ToString ()).GetComponent<AlarmLight>();

//		 Setup the reference to the main directional light in the scene.
//		mainLight = GameObject.FindGameObjectWithTag(Tag.MainLight.ToString ()).GetComponent<Light>();
...
//		GameObject[] sirenGameObjects = GameObject.FindGameObjectsWithTag(Tag.Siren.ToString ());
