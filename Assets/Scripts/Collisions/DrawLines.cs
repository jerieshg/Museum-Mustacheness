...
public class DrawLines : MonoBehaviour
{
	...
	//This linecast captures all the collisions that go through it
	...
	void Update()
	{
        ...
        hitInfo = Physics2D.LinecastAll (transform.position, new Vector2 (transform.position.x + XLineDirection * parentLocalX, transform.position.y + YLineDirection * parentLocalY), lineCollisions);
	}
